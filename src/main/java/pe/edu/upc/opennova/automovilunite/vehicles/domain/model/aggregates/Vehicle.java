...
public class Vehicle extends AuditableAbstractAggregateRoot<Vehicle> {
    ...
    public Vehicle(String model, String brand, String year, String description, String image, Integer price) {
        this.model = model;
        this.brand = brand;
        this.year = year;
    ...
    public Vehicle updateVehicle(String model, String brand, String year, String description, String image, Integer price) {
        this.model = model;
        this.brand = brand;
        this.year = year;
        this.description = description;
